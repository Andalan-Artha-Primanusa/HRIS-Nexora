...
import { ShieldCheck, Search, RefreshCw, DollarSign, Users, Eye, Download, FileText, X, AlertCircle } from 'lucide-react';
          ...
          <div className="modal-completion" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-completion-body">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '8px' }}>
                ...
                >
                  <input type="radio" name="exportTypeTax" checked={exportType === 'bca'} onChange={() => setExportType('bca')} style={{ accentColor: '#2563eb' }} />
                ...
                >
                  <input type="radio" name="exportTypeTax" checked={exportType === 'summary'} onChange={() => setExportType('summary')} style={{ accentColor: '#2563eb' }} />
        ...
        <div className="modal-overlay" onClick={() => setDetailModal(false)}>
          <div className="modal-completion" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '600px' }}>
            <div className="modal-completion-header">
              ...
              <div>
                <h3 className="modal-completion-title">Detail Pajak & BPJS</h3>
